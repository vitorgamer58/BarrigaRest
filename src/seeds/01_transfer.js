exports.seed = (knex) => knex('transactions').del()
  ...
  .then(() => knex('users').insert([
    { id: 10000, name: 'User for Transfer #1', email: 'user100@mail.com', passwd: '$2a$10$8fZO8t7337U00aACrIRPguEl.GaH66BDMmou6pryh9fZGRJ2sZGVa' },
    { id: 10001, name: 'User for Transfer #2', email: 'user200@mail.com', passwd: '$2a$10$8fZO8t7337U00aACrIRPguEl.GaH66BDMmou6pryh9fZGRJ2sZGVa' }
  ]))
