exports.seed = (knex) => knex('transactions').del()
  ...
  .then(() => knex('users').insert([
    { id: 10000, name: 'User #1', email: 'user100@mail.com', passwd: '$2a$10$8fZO8t7337U00aACrIRPguEl.GaH66BDMmou6pryh9fZGRJ2sZGVa' },
    { id: 10001, name: 'User #2', email: 'user200@mail.com', passwd: '$2a$10$8fZO8t7337U00aACrIRPguEl.GaH66BDMmou6pryh9fZGRJ2sZGVa' }
  ]))
  ...
  .then(() => knex('transfers').insert([
    ...
    { id: 10001, description: 'Transfer #2', user_id: 10001, acc_ori_id: 10002, acc_dest_id: 10001, ammount: 100, date: new Date() }
  ]))
